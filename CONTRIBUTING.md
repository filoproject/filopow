Contributing to FILOPOW Core
============================

The FILOPOW Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/The-Filopow-Endeavor/filopow/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the FILOPOW Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Filopow
Network Protocol consensus changes.

Whether a pull request is merged into FILOPOW Core rests with the project merge
...
Patches that change Filopow consensus rules are considerably more involved than
...
Where a patch set proposes to change the Filopow consensus, it must have been
...
The review process is normally fairly responsive on the FILOPOW Core repository, however
...
The project leader is the release manager for each FILOPOW Core release.
