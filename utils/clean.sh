...
rm -f src/config/filopow-config.h
...
rm -rf test_bitcoin.coverage/ filopow-gtest.coverage/ total.coverage/
...
clean_exe src/filopow-cli
clean_exe src/filopowd
clean_exe src/filopow-gtest
clean_exe src/filopow-tx
clean_exe src/test/test_filopow
clean_exe src/test/test_filopow_fuzzy
...
clean_dep . src/config/filopow-config.h.in
