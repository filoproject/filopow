...
class BIP66Test(FilopowTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # filopowd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and filopowd produces more specific reject
            # reasons.
