...
# TestNode: A peer we use to send messages to filopowd, and store responses.
...
class CompactBlocksTest(FilopowTestFramework):
    ...
    # This test actually causes filopowd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that filopowd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for filopowd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # filopowd will not send blocktxn responses for blocks whose height is
