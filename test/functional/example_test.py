...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the FilopowTestFramework
    pass

class ExampleTest(FilopowTestFramework):
    # Each functional test is a subclass of the FilopowTestFramework class.
    ...
    def custom_method(self):
        ...
        FilopowTestFramework class so other tests can use it."""
