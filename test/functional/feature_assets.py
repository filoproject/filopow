...
class AssetTest(FilopowTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("FILOPOW1", 1000)
        n0.issue("FILOPOW2", 1000)
        n0.issue("FILOPOW3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="FILOPOW*", verbose=False, count=2, start=-2)
        ...
        filopow_assets = n0.listassets(asset="FILOPOW*", verbose=False, count=2, start=-2)
        assert_equal(len(filopow_assets), 2)
        assert_equal(filopow_assets[0], "FILOPOW2")
        assert_equal(filopow_assets[1], "FILOPOW3")
        self.sync_all()
