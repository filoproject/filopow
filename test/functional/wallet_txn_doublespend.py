...
class TxnMallTest(FilopowTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 FPOW:
        ...
        # First: use raw transaction API to send 1240 FPOW to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 FPOW coin each
        ...
        # Node0's balance should be starting balance, plus 50FPOW for another
        ...
        # Node0's total balance should be starting balance, plus 100FPOW for 
