...
"""Verify that starting filopowd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start filopowd with -h for help text")
        ...
        self.log.info("Start filopowd with -version for version information")
