...
By default, filopowd will dump mempool on shutdown and
...
class MempoolPersistTest(FilopowTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give filopowd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent filopowd from writing mempool.dat to disk. Verify that `savemempool` fails")
