...
class WalletTest(FilopowTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 FPOW from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 FPOW with subtract fee from amount
        ...
        # Sendmany 10 FPOW with subtract fee from amount
