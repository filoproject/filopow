...
find ${DISTNAME}/bin -type f -executable -exec ../filopow/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../filopow/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/filopow/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/filopow/depends/SDKs/MacOSX10.11.sdk.tar.gz
