...
%{_sbindir}/semanage port -a -t filopow_port_t -p tcp 7766
%{_sbindir}/semanage port -a -t filopow_port_t -p tcp 7767
%{_sbindir}/semanage port -a -t filopow_port_t -p tcp 17766
%{_sbindir}/semanage port -a -t filopow_port_t -p tcp 17767
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 7766
	%{_sbindir}/semanage port -d -p tcp 7767
	%{_sbindir}/semanage port -d -p tcp 17766
	%{_sbindir}/semanage port -d -p tcp 17767
