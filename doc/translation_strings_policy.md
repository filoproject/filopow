...
This document provides guidelines for internationalization of the FILOPOW Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `filopow_en.ts` remains unchanged.
