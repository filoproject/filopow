FILOPOW Core version *2.2.2* is now available!!
==============

  <https://github.com/filoproject/filopow/releases/tag/v2.2.2>
...
- Enhancements for Filopow Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/filoproject/filopow/commits/release_2.2.2>
