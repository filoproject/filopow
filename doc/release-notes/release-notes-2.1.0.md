FILOPOW Core version *2.1.0* is now available!!
==============

  <https://github.com/filoproject/filopow/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/filoproject/filopow/commits/release_2.1.0>
