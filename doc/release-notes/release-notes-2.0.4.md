FILOPOW Core version *2.0.4.0* is now available!!
==============

  <https://github.com/filoproject/filopow/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/filoproject/filopow/commits/release_2.0.4>
