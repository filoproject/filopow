...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            " - \"filopow\" activates all Filopow-specific categories at once;\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "filopow")
            + HelpExampleRpc("debug", "filopow+net")
        );
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Filopow features */
    { "filopow",               "mnsync",                 &mnsync,                 true,  {} },
    { "filopow",               "spork",                  &spork,                  true,  {"value"} },
