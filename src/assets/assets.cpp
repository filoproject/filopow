...
static const std::regex FILOPOW_NAMES("^FPOW$|^FILOPOW$|^FILOPOW$|^#FPOW$|^#FILOPOW$|^#FILOPOW$");
...
void CNewAsset::ConstructTransaction(CScript& script) const
{
    ...
    vchMessage.push_back(FPOW_R); // r
    vchMessage.push_back(FPOW_V); // v
    vchMessage.push_back(FPOW_N); // n
    vchMessage.push_back(FPOW_Q); // q
...
bool TransferAssetFromScript(const CScript& scriptPubKey, CAssetTransfer& assetTransfer, std::string& strAddress)
{
    ...
    if (AreTransferScriptsSizeDeployed()) {
        ...
        // This fixes that issue (https://github.com/filoproject/filopow/issues/752)
