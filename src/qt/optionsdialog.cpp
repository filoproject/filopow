    ...
    mapper(0)
{
    ...
    ui->filopowAtStartup->setToolTip(ui->filopowAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->filopowAtStartup->setText(ui->filopowAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openFilopowConfButton->setToolTip(ui->openFilopowConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new FilopowUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->filopowAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openFilopowConfButton_clicked()
{
