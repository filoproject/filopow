...
#include "config/filopow-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatFilopowURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + FilopowUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatFilopowURI(info));
}
