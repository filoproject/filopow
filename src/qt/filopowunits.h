...
#ifndef FILOPOW_QT_FILOPOWUNITS_H
#define FILOPOW_QT_FILOPOWUNITS_H
...
/** Filopow unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FilopowUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FilopowUnits(QObject *parent);
...
typedef FilopowUnits::Unit FilopowUnit;

#endif // FILOPOW_QT_FILOPOWUNITS_H
