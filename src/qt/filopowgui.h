...
#ifndef FILOPOW_QT_FILOPOWGUI_H
#define FILOPOW_QT_FILOPOWGUI_H
...
/**
  Filopow GUI main class. This class represents the main window of the Filopow UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FilopowGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FilopowGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~FilopowGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a filopow wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
