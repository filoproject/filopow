...
#ifndef FILOPOW_QT_GUICONSTANTS_H
#define FILOPOW_QT_GUICONSTANTS_H
...
/* Filopow shadow color - light mode */
...
/* Filopow label color as a string */
...
#define QAPP_ORG_DOMAIN "filopow.org"
#define QAPP_APP_NAME_DEFAULT "Filopow-Qt"
#define QAPP_APP_NAME_TESTNET "Filopow-Qt-testnet"

/* Default third party browser urls — empty until a FILOPOW explorer exists
 * (Raven's RVN explorers would show the wrong chain). Populate at launch. */
#define DEFAULT_THIRD_PARTY_BROWSERS ""

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // FILOPOW_QT_GUICONSTANTS_H
