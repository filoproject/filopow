...
#include "qt/filopowamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FilopowAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_filopow-qt -platform xcb      # Linux
//     src/qt/test/test_filopow-qt -platform windows  # Windows
//     src/qt/test/test_filopow-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = FilopowUnits::formatWithUnit(unit, balance, false, FilopowUnits::separatorAlways);
    ...
    // Amount input
    FilopowAmountField* amountInput = receiveCoinsDialog.findChild<FilopowAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: filopow:")) != -1);
