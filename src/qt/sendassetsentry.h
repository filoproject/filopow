...
#ifndef FILOPOW_QT_SENDASSETSENTRY_H
#define FILOPOW_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending filopows.
...
#endif // FILOPOW_QT_SENDASSETSENTRY_H
