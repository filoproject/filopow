...
void WalletView::setFilopowGUI(FilopowGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? FilopowGUI::HD44_ENABLED : _walletModel->hdEnabled() ? FilopowGUI::HD_ENABLED : FilopowGUI::HD_DISABLED);
