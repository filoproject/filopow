...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(FilopowUnits::FPOW),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->fpowBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->fpowBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(FilopowUnits::formatWithUnit(unit, balance, false, FilopowUnits::separatorAlways));
    ui->labelUnconfirmed->setText(FilopowUnits::formatWithUnit(unit, unconfirmedBalance, false, FilopowUnits::separatorAlways));
    ui->labelImmature->setText(FilopowUnits::formatWithUnit(unit, immatureBalance, false, FilopowUnits::separatorAlways));
    ui->labelTotal->setText(FilopowUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, FilopowUnits::separatorAlways));
    ui->labelWatchAvailable->setText(FilopowUnits::formatWithUnit(unit, watchOnlyBalance, false, FilopowUnits::separatorAlways));
    ui->labelWatchPending->setText(FilopowUnits::formatWithUnit(unit, watchUnconfBalance, false, FilopowUnits::separatorAlways));
    ui->labelWatchImmature->setText(FilopowUnits::formatWithUnit(unit, watchImmatureBalance, false, FilopowUnits::separatorAlways));
    ui->labelWatchTotal->setText(FilopowUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, FilopowUnits::separatorAlways));
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the FPOW balance grid from expanding and looking terrible when asset balance is hidden
