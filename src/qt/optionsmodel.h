...
#ifndef FILOPOW_QT_OPTIONSMODEL_H
#define FILOPOW_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Filopow client.
...
#endif // FILOPOW_QT_OPTIONSMODEL_H
