 ...
 */
#ifndef FILOPOW_UTIL_H
#define FILOPOW_UTIL_H
...
extern const char *const FILOPOW_CONF_FILENAME;
extern const char *const FILOPOW_PID_FILENAME;
...
{
    std::string s = strprintf("filopow-%s", name);
