...
#ifndef FILOPOW_PROTOCOL_H
#define FILOPOW_PROTOCOL_H
...
/**
 * Filopow protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // FILOPOW Core does not support this but a patch set called Filopow XT does.
    ...
    // filopow-development mailing list. Remember that service bits are just
