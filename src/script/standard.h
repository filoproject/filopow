...
#ifndef FILOPOW_SCRIPT_STANDARD_H
#define FILOPOW_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a filopow address
 */
...
/**
 * Generate a Filopow scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // FILOPOW_SCRIPT_STANDARD_H
