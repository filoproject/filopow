...
#ifndef FILOPOW_TEST_SCRIPTNUM10_H
#define FILOPOW_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from FILOPOW Core 0.10.0, for cross-comparison.
 */
public:
