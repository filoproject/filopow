...
BOOST_FIXTURE_TEST_SUITE(rpc_tests, TestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(rpc_rawsign_test)
    {
        ...
        r = CallRPC(std::string("createrawtransaction ") + prevout + " " +
                    "{\"fWFTFvApGRSeUftrQjXG9kHiqyfSS5VteP\":11}");
    ...
    BOOST_AUTO_TEST_CASE(rpc_createraw_assets_test)
    {
        ...
        fUnitTest = true;
        BOOST_CHECK_NO_THROW(CallRPC("createrawtransaction [{\"txid\":\"a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed\",\"vout\":0}] {\"fWFTFvApGRSeUftrQjXG9kHiqyfSS5VteP\":20000}"));
        BOOST_CHECK_NO_THROW(CallRPC("createrawtransaction [{\"txid\":\"a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed\",\"vout\":0}] {\"fWFTFvApGRSeUftrQjXG9kHiqyfSS5VteP\":{\"transfer\":{\"FILOPOW_ASSET\":20000}}}"));
        BOOST_CHECK_NO_THROW(CallRPC("createrawtransaction [{\"txid\":\"a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed\",\"vout\":0}] {\"fWFTFvApGRSeUftrQjXG9kHiqyfSS5VteP\":{\"issue\":{\"asset_name\":\"FILOPOW_ASSET\",\"asset_quantity\":20000,\"units\":0,\"reissuable\":1,\"has_ipfs\":0}}}"));

        // one address multiple asset outs
        BOOST_CHECK_NO_THROW(CallRPC("createrawtransaction [{\"txid\":\"a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed\",\"vout\":0}] {\"fWFTFvApGRSeUftrQjXG9kHiqyfSS5VteP\":{\"transfer\":{\"FILOPOW_ASSET\":20000,\"FILOPOW_ASSET_2\":20000}}}"));

        // multiple coin outs
        BOOST_CHECK_NO_THROW(CallRPC("createrawtransaction [{\"txid\":\"a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed\",\"vout\":0}] {\"fWFTFvApGRSeUftrQjXG9kHiqyfSS5VteP\":20000,\"FpkHYmF1UKeazba9ZqWi8k3crBY72483kn\":20000}"));

        // coin and asset out
        BOOST_CHECK_NO_THROW(CallRPC("createrawtransaction [{\"txid\":\"a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed\",\"vout\":0}] {\"fWFTFvApGRSeUftrQjXG9kHiqyfSS5VteP\":20000,\"FpkHYmF1UKeazba9ZqWi8k3crBY72483kn\":{\"transfer\":{\"FILOPOW_ASSET\":20000}}}"));

        // coin and asset out with message
        BOOST_CHECK_NO_THROW(CallRPC("createrawtransaction [{\"txid\":\"a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed\",\"vout\":0}] {\"fWFTFvApGRSeUftrQjXG9kHiqyfSS5VteP\":20000,\"FpkHYmF1UKeazba9ZqWi8k3crBY72483kn\":{\"transferwithmessage\":{\"FILOPOW_ASSET\":20000,\"message\":\"QmTqu3Lk3gmTsQVZZZZZZEAW4xZZZZNmbuEAp2Mjr4AV7E\",\"expire_time\":0}}}"));

        // bad command
        BOOST_CHECK_THROW(CallRPC("createrawtransaction [{\"txid\":\"a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed\",\"vout\":0}] {\"fWFTFvApGRSeUftrQjXG9kHiqyfSS5VteP\":{\"badcommand\":{\"FILOPOW_ASSET\":20000}}}"), std::runtime_error);
    }
    ...
    BOOST_AUTO_TEST_CASE(json_parse_errors_test)
    {
        ...
        BOOST_CHECK_THROW(ParseNonRFCJSONValue("1.0]"), std::runtime_error);
        // FPOW addresses should fail parsing
