...
BOOST_FIXTURE_TEST_SUITE(serialization_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(issue_asset_serialization_test)
    {
        ...
        // Create destination
        CTxDestination dest = DecodeDestination("movdukV7JSCDozhUZYGQz5wbL9AnhvHtsL"); // Testnet Address
        ...
        BOOST_CHECK_MESSAGE(address == "movdukV7JSCDozhUZYGQz5wbL9AnhvHtsL", "Addresses weren't equal");
