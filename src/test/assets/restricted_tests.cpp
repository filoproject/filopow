...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler fpow tx
        CScript fpowTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut fpowOut(1*COIN, fpowTransfer);
        ...
        mutTxTest1.vout.emplace_back(fpowOut);
        ...
        mutTxTest2.vout.emplace_back(fpowOut);
        ...
        mutTxTest3.vout.emplace_back(fpowOut);
        ...
        mutTxTest4.vout.emplace_back(fpowOut);
        ...
        mutTxTest5.vout.emplace_back(fpowOut);
        ...
        mutTxTest6.vout.emplace_back(fpowOut);
        ...
        mutTxTest7.vout.emplace_back(fpowOut);
        ...
        mutTxTest8.vout.emplace_back(fpowOut);
